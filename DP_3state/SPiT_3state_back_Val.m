function j_next = SPiT_3state_back_Val(stage,coef,t,t_qu,sh,sh_qu,vh,vh_qu,sf,sf_qu,f_qu,slope,j_pre,totalstage,safe_dg,theta)
stage*t_qu
nsh = size(sh,1);
nvh = size(vh,2);
nsf = size(sf,1);
