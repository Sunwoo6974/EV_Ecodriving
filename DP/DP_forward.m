...
% Scenario 3 : Car Following
% By Sunwoo Kim
% 0 - 200m까지 host vehicle
% 전방차량은 그 이상 달림
...
NRG1 = zeros(Totalstage,1);
NRG2 = zeros(Totalstage,1);
